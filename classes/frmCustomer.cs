...
namespace Payment
{
    ...
    public partial class frmCustomer : Form
    {
        ...
        private bool IsValidData()
        {
            ...
            {
                MessageBox.Show("You must select a customer.", "Entry Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                cboNames.Focus();
                return false;
            }
            if (lblPayment.Text == "")
            {
                MessageBox.Show("You must enter a payment.", "Entry Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
            return true;
        }
